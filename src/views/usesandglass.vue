...
<div style="width: 80%;margin:auto">
    <diagram ref='diag' :model-data='diagramData' @model-changed='modelChanged' @changed-selection='changedSelection' style='border: solid 1px black; width:100%; height:400px'></diagram>
...
<script>
import diagram from '../components/sandglass'
